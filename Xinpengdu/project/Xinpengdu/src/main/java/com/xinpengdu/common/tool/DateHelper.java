...
public class DateHelper {
    ...
    public static String formatDate(Long date) {
        return date == null?"":DateFormatUtils.format(date.longValue(), "yyyy-MM-dd HH:mm:ss");
    }

    public static String formatDateYYYYMM(Long date) {
        return date == null?"":DateFormatUtils.format(date.longValue(), "yyyyMM");
    }

    public static String formatDateYYYY(Long date) {
        return date == null?"":DateFormatUtils.format(date.longValue(), "yyyy");
    }
    ...
    public static Date toDate(String dateStr, String sourceformat) {
        ...
        try {
            ...
            throw ExceptionUtils.toUnchecked(var5, "时间转换失败！");
        }
    }
