...
!function ($) {
    ...
    BootstrapTable.DEFAULTS = {
        ...
        onPageChange: function (number, size, totalPages) {
            return false;
        },
    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        if (!this.options.onlyInfoPagination) {
            ...
            // fixed by zengx 修改pagination的翻页策略
            if (this.totalPages === 1) {
                $pre.addClass('disabled');
                $next.addClass('disabled');
            } else if (this.options.pageNumber === this.totalPages) {
                $next.addClass('disabled');
            } else if (this.options.pageNumber === 1) {
                $pre.addClass('disabled');
            } else {
    ...
    BootstrapTable.prototype.updatePagination = function (event) {
        ...
        this.trigger('page-change', this.options.pageNumber, this.options.pageSize, this.options.totalPages);
    };
